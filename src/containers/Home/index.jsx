...
function Home(props) {
  ...
  return (
    <>
      {/* background */}
      <div
        className={`fixed h-screen w-full z-20 bg-black  ${
          formFocus
            ? "block bg-opacity-50 dark:bg-opacity-60"
            : "hidden bg-opacity-0"
        }`}
      />

      {/* main */}
      <main className="flex-grow dark:bg-gray-800 dark:text-white dark:overflow-hidden">
        ...
        {/* FORM */}
        <div
          className={`w-full fixed z-30 top-24 transform ${
            formFocus ? "block" : "hidden"
          }`}
        >
          <div className="px-4 container max-w-screen-sm mx-auto dark:text-gray-800">
